...
export class World {
    ...
    * @returns {World}
    */
    static new(width, snake_idx, length) {
        const ret = wasm.world_new(width, snake_idx, length);
...
function getImports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_rand_808a2f66f8543a0e = function(arg0) {
        const ret = rand(arg0 >>> 0);
        return ret;
    };
